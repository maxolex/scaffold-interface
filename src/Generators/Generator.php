...
use Maxolex\ScaffoldInterface\Filesystem\Filesystem;
...
class Generator extends Filesystem
{
     ...
     *
     * @var \Maxolex\ScaffoldInterface\Generators\ViewGenerate
     */
    private $view;
     ...
     * The ViewGenerate instance.
     *
     * @var \Maxolex\ScaffoldInterface\Generators\ModelGenerate
     */
    private $model;
     ...
     * The ViewGenerate instance.
     *
     * @var \Maxolex\ScaffoldInterface\Generators\MigrationGenerate
     */
    private $migration;
     ...
     * The ViewGenerate instance.
     *
     * @var \Maxolex\ScaffoldInterface\Generators\ControllerGenerate
     */
    private $controller;
     ...
     * The ViewGenerate instance.
     *
     * @var \Maxolex\ScaffoldInterface\Generators\RouteGenerate
     */
    private $route;
     ...
     * The ViewGenerate instance.
     *
     * @var \Maxolex\ScaffoldInterface\Filesystem\Path
     */
    private $paths;
     ...
     *
     * @return \Maxolex\ScaffoldInterface\Generators\ModelGenerate
     */
     ...
     *
     * @return \Maxolex\ScaffoldInterface\Generators\MigrationGenerate
     */
     ...
     *
     * @return \Maxolex\ScaffoldInterface\Generators\ViewGenerate
     */
     ...
     *
     * @return \Maxolex\ScaffoldInterface\Generators\ControllerGenerate
     */
     ...
     * get route.
     *
     * @return \Maxolex\ScaffoldInterface\Generators\RouteGenerate
     */
