...
Route::group(['middleware' => 'web'], function () {
    Route::get('scaffold', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@index');

    Route::post('scaffold/guipost', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@store');

    Route::get('scaffold/guirollback/{id}', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@destroy');

    Route::get('scaffold/guidelete/{id}', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@deleteMsg');

    Route::get('scaffold/getAttributes/{table}', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@getResult');

    Route::get('scaffold/migrate', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@migrate');

    Route::get('scaffold/rollback', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@rollback');

    Route::get('scaffold/manyToManyForm', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@manyToManyForm');

    Route::post('scaffold/manyToMany', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@manyToMany');

    Route::get('scaffold/graph', '\Maxolex\ScaffoldInterface\Http\Controllers\GuiController@graph');
});
...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    //Dashboard
    Route::get('home', '\App\Http\Controllers\ScaffoldInterface\AppController@semantic_dashboard');
